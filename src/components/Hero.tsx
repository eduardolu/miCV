...
const particles = [
  { left: 18, top: 24, delay: 0.2, duration: 7.2 },
  { left: 31, top: 68, delay: 1.4, duration: 8.8 },
  { left: 44, top: 18, delay: 2.1, duration: 7.6 },
  { left: 57, top: 76, delay: 3.8, duration: 9.4 },
  { left: 72, top: 32, delay: 0.9, duration: 6.8 },
  { left: 84, top: 57, delay: 4.6, duration: 8.2 },
  { left: 12, top: 74, delay: 5.1, duration: 9.8 },
  { left: 25, top: 41, delay: 2.9, duration: 7.1 },
  { left: 66, top: 16, delay: 6.3, duration: 8.5 },
  { left: 79, top: 83, delay: 1.8, duration: 9.1 },
  { left: 39, top: 88, delay: 4.2, duration: 6.9 },
